...
UID = 153959654  # 你的UID
ACCESS_KEY = "6989be05866271bf5425d1eafd5f3b12"  # 你的ACCESS_KEY (TV端,非TV端自行更换下面的APPKEY,APPSECRET,TV端access_key获取工具 https://github.com/XiaoMiku01/fansMedalHelper/releases/tag/logintool)
FACE_PATH = r"IMG.png"  # 头像路径 推荐正方形
...
def get_one_card_id():
    ...
    if data['code'] != 0:
        print(data)
        return
    for round in data['data']['pre_list']:
        card = round
